...
public class MatchHistoryController implements MessageListener {
    ...
    private void requestHistory() {
        try {
            ...
            network.send(new Message("GET_HISTORY", "CLIENT", null));
    ...
    private List<MatchRecord> format(List<Game> history) {
        ...
        for (Game g : history) {
            ...
            record.setStartTime(g.getTime().toString());
    ...
    public void onMessageReceived(Message msg) {
        ...
        if ("GET_HISTORY_RESPONSE".equals(msg.getCommand())) {
            List<Game> list = (List<Game>) msg.getContent();
